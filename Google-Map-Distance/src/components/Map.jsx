  ...
  return (
    <div className="home">
        ...
        <div className="container">
            <p className='heading'>Let's calculate  <span style={{fontWeight:"1000"}}>distance</span> from Google maps</p>
        ...
        <div className="locations">
            ...
            <div className="location-container">
                ...
                <div className="waypoints">
                    ...
                    <Autocomplete>
                    <input type="text" className='input2' placeholder='Stop' id='2' ref={waypointRef} />
                    </Autocomplete>
                   <div >
            ...
            <div className="distance">
                ...
                <div className='distance-text'>
                    {!loading ? (
                        <p>The distance between <span style={{fontWeight:"800"}}>{origin}</span> and <span style={{fontWeight:"800"}}>{destination}</span> via the seleted route is <span style={{fontWeight:"800"}}>{distance}s.</span></p>
                    ) : (
